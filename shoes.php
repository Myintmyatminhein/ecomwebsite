...
$sql = $db->prepare("SELECT * FROM shoes");
$sql->execute();
?>
<head>
  <title>Capital</title>
...
.new-arrival div img
{
   ...
   <h1 style="  text-align:center;margin:30px;font-family:Rosewood Std Regular;font-size:30px;color: cyan;">Shoes from Different brands</h1>
...
<div class="col-sm-3" align="center" >
	<form action="managecart.php" method="POST">
		<img src="shoesimages/<?php echo $photo; ?>" width="90%" height= auto; ><br>
