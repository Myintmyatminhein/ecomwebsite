...
$eid = $_GET['eid'];
$sql = $db->prepare("SELECT * FROM pants WHERE IID='$eid'");
$sql->execute();
...
<body>
  <div>
	<form method="POST" action="updateprocesspants.php" enctype="multipart/form-data" >
	...
	<br>
	<img src="pantsimages/<?php echo $photo;?>" width="100" height="100"><br>
