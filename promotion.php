...
.new-arrival div img
{
   ...
   <h1 style="  text-align:center;margin:30px;font-family:Rosewood Std Regular;font-size:30px;color: Cyan;">Promotion Products from Different brands</h1>
...
<div class="col-sm-3" align="center" >
	<form action="managecart.php" method="POST">
		<img src="promoimages/<?php echo $photo; ?>" width="90%" height= auto; ><br>
