...
$eid = $_GET['eid'];
$sql = $db->prepare("SELECT * FROM promoitem WHERE IID='$eid'");
$sql->execute();
...
<body>
  <div>
	<form method="POST" action="updateprocesspromo.php" enctype="multipart/form-data" >
	...
	<br>
	<img src="promoimages/<?php echo $photo;?>" width="100" height="100"><br>
