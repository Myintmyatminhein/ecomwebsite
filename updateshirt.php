...
$eid = $_GET['eid'];
$sql = $db->prepare("SELECT * FROM shirt WHERE IID='$eid'");
$sql->execute();
...
<body>
  <div>
	<form method="POST" action="updateprocessshirt.php" enctype="multipart/form-data" >
	...
	<br>
	<img src="shirtimages/<?php echo $photo;?>" width="100" height="100"><br>
